    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('M', 'Masculino'), ('F', 'Feminino'), ('O', 'Outro'), ('P', 'Prefiro não dizer')], max_length=1, verbose_name='Genero')),
                ('telefone', models.CharField(max_length=15, verbose_name='Telefone')),
                ('cep', models.CharField(max_length=9, validators=[django.core.validators.MinLengthValidator(9)], verbose_name='CEP')),
                ...
                ('numeroResidencial', models.CharField(max_length=10, verbose_name='Número da residência')),
                ('idGroup', models.IntegerField(default=1, verbose_name='Id do grupo')),
                ...
                ('cidade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cidade_UsuarioFK', to='usuarios.cidade')),
